...
require_once(dirname(__FILE__) . 'NativeSerializer.php');
require_once(dirname(__FILE__) . 'NativeSender.php');
require_once(dirname(__FILE__) . 'StatusCodeSender.php');
require_once(dirname(__FILE__) . 'SigningSender.php');
require_once(dirname(__FILE__) . 'LicenseSender.php');
require_once(dirname(__FILE__) . 'RetrySender.php');
require_once(dirname(__FILE__) . 'URLPrefixSender.php');
require_once(dirname(__FILE__) . 'Batch.php');
require_once(dirname(__FILE__) . 'MyLogger.php');
require_once(dirname(__FILE__) . 'MySleeper.php');
