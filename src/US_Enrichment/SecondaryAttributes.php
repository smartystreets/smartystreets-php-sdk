...
require_once(dirname(__FILE__) . '/Secondary/RootAddressEntry.php');
require_once(dirname(__FILE__) . '/Secondary/AliasesEntry.php');
require_once(dirname(__FILE__) . '/Secondary/SecondariesEntry.php');
