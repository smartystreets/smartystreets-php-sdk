...
require_once(dirname(__FILE__) . '/GeoReference/CensusBlockEntry.php');
require_once(dirname(__FILE__) . '/GeoReference/CensusCountyDivisionEntry.php');
require_once(dirname(__FILE__) . '/GeoReference/CensusTractEntry.php');
require_once(dirname(__FILE__) . '/GeoReference/CoreBasedStatAreaEntry.php');
require_once(dirname(__FILE__) . '/GeoReference/PlaceEntry.php');
